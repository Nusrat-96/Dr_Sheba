...
class Doctor(models.Model):
    ...
    education = models.CharField(max_length=255, blank=True, help_text="e.g., MD from Harvard Medical School")
    languages = models.CharField(max_length=255, blank=True, help_text="e.g., English, Bengali")
    location = models.CharField(max_length=255, blank=True, help_text="e.g., Dhaka, Bangladesh")
